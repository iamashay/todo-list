...
/***/ "./src/modules/cookieController.js":
/*!*****************************************!*\
  !*** ./src/modules/cookieController.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "processFetchedCookie": () => (/* binding */ processFetchedCookie),
/* harmony export */   "resetCookie": () => (/* binding */ resetCookie),
/* harmony export */   "updateCookie": () => (/* binding */ updateCookie)
/* harmony export */ });
/* harmony import */ var _projectModel_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./projectModel.js */ "./src/modules/projectModel.js");
/* harmony import */ var _projectFunctions_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./projectFunctions.js */ "./src/modules/projectFunctions.js");
/* harmony import */ var _taskFunctions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taskFunctions */ "./src/modules/taskFunctions.js");
...
function updateCookie(){
    const data = (0,_projectModel_js__WEBPACK_IMPORTED_MODULE_0__.getProjectList)();
...
function processFetchedCookie(){
    ...
    if (data){
        (0,_projectModel_js__WEBPACK_IMPORTED_MODULE_0__.emptyProjectList)();
        for (let project of Object.keys(data)){
            (0,_projectFunctions_js__WEBPACK_IMPORTED_MODULE_1__.createProject)(project)
            for (let task of data[project].taskList){
                ;(0,_taskFunctions__WEBPACK_IMPORTED_MODULE_2__.createTask)(project, task)
            }
        }
...
/* harmony export */ });
/* harmony import */ var _globalFunctions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./globalFunctions.js */ "./src/modules/globalFunctions.js");


class Popup {

    static new(myForm){
        const popupContainer = (0,_globalFunctions_js__WEBPACK_IMPORTED_MODULE_0__.qs)(".popup-container");
    ...
    static toggle() {
        const popupOverlay = (0,_globalFunctions_js__WEBPACK_IMPORTED_MODULE_0__.qs)(".popup-overlay");
        const popupContainer = (0,_globalFunctions_js__WEBPACK_IMPORTED_MODULE_0__.qs)(".popup-container");
...
function makeNameUnique(projectName){
    ...
    while (tempName in _projectModel_js__WEBPACK_IMPORTED_MODULE_0__.projectList){
...
function createProject(projectName){
    ...
    const newProject = new _projectModel_js__WEBPACK_IMPORTED_MODULE_0__.Project(projectName);
    _projectModel_js__WEBPACK_IMPORTED_MODULE_0__.projectList[projectName] = newProject;
    return projectName;
}
...
function editProject(oldProjectName, newProjectName){
    const myProject = _projectModel_js__WEBPACK_IMPORTED_MODULE_0__.projectList[oldProjectName];
    if (!(newProjectName in _projectModel_js__WEBPACK_IMPORTED_MODULE_0__.projectList)) {
        myProject.name = newProjectName;
        //create a propery with the new name and copy old property's data to it
        _projectModel_js__WEBPACK_IMPORTED_MODULE_0__.projectList[newProjectName] = _projectModel_js__WEBPACK_IMPORTED_MODULE_0__.projectList[oldProjectName]; 
        //delete the old property
        delete _projectModel_js__WEBPACK_IMPORTED_MODULE_0__.projectList[oldProjectName];
    }
    return myProject;
}

function deleteProject(projectName){
    if (Object.getOwnPropertyNames(_projectModel_js__WEBPACK_IMPORTED_MODULE_0__.projectList).length == 1) return;

    if (projectName in _projectModel_js__WEBPACK_IMPORTED_MODULE_0__.projectList){
        delete _projectModel_js__WEBPACK_IMPORTED_MODULE_0__.projectList[projectName];
        return true;
    }
    return false;
}
...
function getProjects() {
    return Object.getOwnPropertyNames(_projectModel_js__WEBPACK_IMPORTED_MODULE_0__.projectList);
}
...
/* harmony export */   "emptyProjectList": () => (/* binding */ emptyProjectList),
...
/* harmony export */   "getSpecificTask": () => (/* binding */ getSpecificTask),
...
function createTask(projectName, jsonValue){
    const newTask = new _taskModel__WEBPACK_IMPORTED_MODULE_0__.Task(jsonValue.title, jsonValue.dueDate, jsonValue.description, jsonValue.isImportant, jsonValue.status, jsonValue.projectName);
    _projectModel__WEBPACK_IMPORTED_MODULE_1__.projectList[projectName].taskList.unshift(newTask);
    return newTask;
}

function editTask(projectName, taskID, jsonValue){
    const myTask = _projectModel__WEBPACK_IMPORTED_MODULE_1__.projectList[projectName].taskList[taskID];
...
function deleteTask(projectName, taskID){
    const myProject = _projectModel__WEBPACK_IMPORTED_MODULE_1__.projectList[projectName];
    myProject.splice(taskID, 1);
}

function getTasks(projectName){
    return _projectModel__WEBPACK_IMPORTED_MODULE_1__.projectList[projectName].taskList;
}

function getSpecificTask(projectName, taskID){
    return _projectModel__WEBPACK_IMPORTED_MODULE_1__.projectList[projectName].taskList[taskID];
}
...
/*!**********************************!*\
  ...
  \**********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_projectFunctions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/projectFunctions.js */ "./src/modules/projectFunctions.js");
...
/* harmony import */ var _modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/globalFunctions.js */ "./src/modules/globalFunctions.js");
...
/* harmony import */ var _modules_loadPage_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/loadPage.js */ "./src/modules/loadPage.js");
/* harmony import */ var _modules_cookieController_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/cookieController.js */ "./src/modules/cookieController.js");
...
const taskListContainer = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(".task-list-container");
const projectListContainer = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#project-list");
...
class taskList {
    ...
    static buildTaskElement(task, projectName, taskID) {
        ...
        const date =  (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(task.dueDate), "do MMMM, yyyy");
    ...
    static filter(task){
        const whenOption = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(".when-options");
        const statusOption = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(".status-option");
        ...
        const compareDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(taskDueDate, currentDate);
        let filterPassed = 0;
    ...
    static update(projectName, showAll = leftSidebar.showAll, fav = leftSidebar.fav){
        ...
        if (showAll){
            ...
            const projects = _modules_projectFunctions_js__WEBPACK_IMPORTED_MODULE_0__.getProjects();
            for (let projectName of projects){
                const tasks = _modules_taskFunctions_js__WEBPACK_IMPORTED_MODULE_1__.getTasks(projectName);
    ...
    static markTaskStatus(task, projectName, taskIndex){
        const checkbox = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(`.task[data-project="${projectName}"][data-task="${taskIndex}"] input`);
        task.status = checkbox.checked;
    }

    static markImportant(task, projectName, taskIndex){
        const starImage = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(`.task[data-project="${projectName}"][data-task="${taskIndex}"] .task-important`);
        ...
        _modules_cookieController_js__WEBPACK_IMPORTED_MODULE_5__.updateCookie();
    }

    static changeTabName(name){
        const tabDiv = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#tab-name");
...
class taskDropdownMenu {
    static build(projectName, taskID){
        ...
        editOption.addEventListener("click", ()=>{
            _modules_popup_js__WEBPACK_IMPORTED_MODULE_3__.Popup["new"]((0,_modules_loadPage_js__WEBPACK_IMPORTED_MODULE_4__.generateEditTaskForm)());
            this.populateEditForm(projectName, taskID);
            _modules_popup_js__WEBPACK_IMPORTED_MODULE_3__.Popup.toggle()
            const myForm = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(".edit-task-form");
    ...
    static populateEditForm(projectName, taskID){
        const currentTask = _modules_taskFunctions_js__WEBPACK_IMPORTED_MODULE_1__.getSpecificTask(projectName, taskID); 
        const title = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#task-title");
        let dueDate = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#task-due-date");
        const isImportant = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#task-important");
        const description = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#task-description");
        

        title.value = currentTask.title;
        dueDate.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(currentTask.dueDate), "yyyy-MM-dd");
    ...
    static processEditForm(projectName, taskID){
        const title = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#task-title").value;
        let dueDate = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#task-due-date").value;
        const isImportant = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#task-important").checked;
        const description = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#task-description").value;
        const myForm = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(".edit-task-form");
        if (title && title.length > 0){
            dueDate = +new Date(dueDate);

            _modules_taskFunctions_js__WEBPACK_IMPORTED_MODULE_1__.editTask(projectName, taskID, {
    ...
    static delete(projectName, taskIndex) {
        _modules_taskFunctions_js__WEBPACK_IMPORTED_MODULE_1__.getTasks(projectName).splice(taskIndex, 1);
        _modules_cookieController_js__WEBPACK_IMPORTED_MODULE_5__.updateCookie();
    }
...
class addTaskForm {
    ...
    static processForm(event){
        ...
        let dueDate = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#task-due-date").value;
        const isImportant = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#task-important").checked;
        let description = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#task-description").value;
        
        const myForm = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(".add-task-form");
        const projectName = projectNodes.currentProject;
        let newTask;
        if (title && title.length > 0){
            dueDate = +new Date(dueDate);
            newTask = _modules_taskFunctions_js__WEBPACK_IMPORTED_MODULE_1__.createTask(projectName, {
    ...
    static hideButton(){
        const addTaskPopupButton = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#add-task");
    ...
    addTaskPopupButton.addEventListener("click", () => {
        const myForm = Popup.new((0,_modules_loadPage_js__WEBPACK_IMPORTED_MODULE_4__.generateAddTaskForm)())
        Popup.toggle()
...
class leftSidebar {
    ...
    static toggle(){
        ...
        const sidebar = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#sidebar");
    ...
    static init(){
        const menuBtn = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(".menu-icon");
        const showAllOption = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#show-all")
        const favOption = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)("#favourite")
...
class projectNodes {
    static currentProject = _modules_projectFunctions_js__WEBPACK_IMPORTED_MODULE_0__.getProjects()[0];

    static build(projectName){
        const projectsBox = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(".projects");
        ...
        deleteBtn.src = __webpack_require__(/*! ./res/imgs/delete-project.png */ "./src/res/imgs/delete-project.png");
        ...
        editBtn.src = __webpack_require__(/*! ./res/imgs/edit-project.png */ "./src/res/imgs/edit-project.png");
    ...
    static makeDefault(projectName){
        ...
        const previousProject = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(`li[data-project="${this.currentProject}"]`);
        previousProject.classList = `project project-inactive`;
        const project = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(`li[data-project="${projectName}"]`);
    ...
    static createNewProject(){
        const newProjectName = _modules_projectFunctions_js__WEBPACK_IMPORTED_MODULE_0__.createProject("Untitled");
    ...
    static init(){
        ...
        const initialProject = _modules_projectFunctions_js__WEBPACK_IMPORTED_MODULE_0__.getProjects()[0];
        this.makeDefault(initialProject)
        const addProjectBtn = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(".add-project");
        addProjectBtn.addEventListener("click", this.createNewProject.bind(this));
    }

    static resetCurrentProject(){
        this.currentProject = _modules_projectFunctions_js__WEBPACK_IMPORTED_MODULE_0__.getProjects()[0];
    }
}

class projectOptions {
    static deleteProject(projectName){
        let isDeleted = _modules_projectFunctions_js__WEBPACK_IMPORTED_MODULE_0__.deleteProject(projectName);
    ...
    static showOptions(projectName){
        const imgs = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qsAll)(`.project[data-project="${projectName}"] img`);
        for (let img of imgs){
    ...
    static editProject(projectName){
        const projectNameDiv = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qs)(`.project[data-project="${projectName}"] .project-name`);
        ...
        projectNameDiv.addEventListener("focusout", (e) => {
                ...
                if(projectName !== newProjectName){
                    ...
                    _modules_projectFunctions_js__WEBPACK_IMPORTED_MODULE_0__.editProject(projectName, newProjectName);
                    projectNodes.populateProjectBox(true);
                    projectNodes.makeDefault(projectNodes.currentProject);  
                }
                _modules_cookieController_js__WEBPACK_IMPORTED_MODULE_5__.updateCookie();
...
function displayController() {
    _modules_cookieController_js__WEBPACK_IMPORTED_MODULE_5__.processFetchedCookie();
    _modules_popup_js__WEBPACK_IMPORTED_MODULE_3__.Popup.init();
    addTaskForm.init(_modules_popup_js__WEBPACK_IMPORTED_MODULE_3__.Popup);
    taskList.update("Personal"); 
    leftSidebar.init();
    projectNodes.init();
    const taskContainerOptions = (0,_modules_globalFunctions_js__WEBPACK_IMPORTED_MODULE_2__.qsAll)(".task-container-option");
